        ...
        if ($rol['nombre_rol'] === 'Estudiante') : ?>
            ...
            <div class="card-body">
                ...
                <table class="table table-hover table-striped">
                    ...
                    <a href="index.php?action=reporteEstudiante&idEstudiante=<?php echo $idEstudiante; ?>">
        ...
        <?php elseif ($rol['nombre_rol'] === 'Profesor') : ?>
            ...
            <div class="card-body">
                ...
                <table class="table table-hover table-striped">
                    ...
                    <a href="index.php?action=reporteProfesor&idProfesor=<?php echo $idEstudiante; ?>">
                        <button class="btn btn-danger">Generar Reporte</button>
                    </a>
                </table>
            </div>
